...
export const UPGRADE_VIDEOS = {
  ...
  fortyNinthHeatherEb26: {
    id: "t9uHv6QvqUU",
    title: "49th Ave around Heather",
    routeNames: [ROUTES.heather.name],
    direction: "eastbound",
    date: new Date("Jan 13 2026"),
    minutes: 1,
    position: [49.22631, -123.1225],
    region: REGIONS.vancouver,
  },
  ...
  beattyRobsonNb26: {
    ...
    date: new Date("May 26 2026"),
    minutes: 1,
    position: [49.27738, -123.11421],
    region: REGIONS.vancouver,
  },
  beattyRobsonSb26: {
    id: "SIx4JTTPvwA",
    title: "Beatty St @ Robson St (SB)",
    routeNames: [ROUTES.beatty.name],
    direction: "southbound",
    date: new Date("May 26 2026"),
    minutes: 1,
  ...
  fourteenthMainWb26: {
    id: "DmHMkgzpAWs",
    title: "14th Plaza @ Main",
    routeNames: [ROUTES.fourteenth.name],
    direction: "westbound",
    date: new Date("June 11 2026"),
    minutes: 0,
    position: [49.25839, -123.1008],
    region: REGIONS.vancouver,
  },
  fourteenthGranvilleWb26: {
    id: "SdcePKtfhF8",
    title: "14th Plaza @ Granville",
    routeNames: [ROUTES.fourteenth.name],
    direction: "westbound",
    date: new Date("June 11 2026"),
    minutes: 0,
