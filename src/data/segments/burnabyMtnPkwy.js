...
export const BURNABY_MOUNTAIN_PARKWAY = [
  // hastings
  {
    ...
    type: "shared",
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.burnabyMtnEb.id],
    positions: [
      DUTHIE_HASTINGS_S,
      [49.28033, -122.95221],
      [49.28032, -122.95166],
  ...
  },
  {
    ...
    type: "shoulder",
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.burnabyMtnWb.id],
    positions: [
  ...
  // route
  {
    ...
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.burnabyMtnEb.id],
    videoIdsEndAtEnd: [ROUTE_VIDEOS.burnabyMtnEb.id],
    positions: [
      BURNABY_MTN_HASTINGS_S,
      [49.27862, -122.94808],
      [49.27768, -122.9465],
  ...
  },
  {
    ...
    type: "shoulder",
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.gaglardiSb.id, ROUTE_VIDEOS.burnabyMtnWb.id],
    videoIdsStartAtStart: [
      ROUTE_VIDEOS.gaglardiSb.id,
