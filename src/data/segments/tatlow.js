...
export const TATLOW = [
  {
    ...
    type: "mixed",
    videoIds: [ROUTE_VIDEOS.tatlowNb.id, ROUTE_VIDEOS.tatlowSb.id],
    videoIdsEndAtStart: [ROUTE_VIDEOS.tatlowSb.id],
  ...
  },
  {
    ...
    type: "mixed",
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.tatlowSb.id, ROUTE_VIDEOS.fifteenthEb.id],
    positions: [
      TATLOW_PARK_N,
      [49.32334, -123.11764],
      [49.32325, -123.11772],
  ...
  },
  {
    ...
    type: "quiet",
    videoIds: [
      ROUTE_VIDEOS.tatlowSb.id,
      ROUTE_VIDEOS.tatlowNb.id,
      ROUTE_VIDEOS.fifteenthEb.id,
    ],
    videoIdsStartAtEnd: [ROUTE_VIDEOS.tatlowSb.id],
