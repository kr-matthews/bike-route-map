...
export const CRABAPPLE_RIDGE = [
  ...
  },
  {
    ...
    type: "other",
    videoIds: [ROUTE_VIDEOS.crabappleSb.id],
    videoIdsEndAtEnd: [ROUTE_VIDEOS.crabappleSb.id],
    positions: [
      STEVESTON_COMMUNITY_PARK_IMPERIAL_N,
      [49.12305, -123.17414],
      STEVESTON_COMMUNITY_PARK_WESTWATER,
  ...
  },
  {
    ...
    description: "barnard",
    type: "shared",
    videoIds: [ROUTE_VIDEOS.crabappleSb.id, ROUTE_VIDEOS.granvilleWb.id],
    positions: [
      BARNARD_GRANVILLE,
      [49.16303, -123.18445],
      [49.16308, -123.18449],
  ...
  },
  {
    ...
    type: "mixed",
    videoIds: [ROUTE_VIDEOS.crabappleSb.id, ROUTE_VIDEOS.granvilleWb.id],
    videoIdsStartAtEnd: [ROUTE_VIDEOS.crabappleSb.id],
    videoIdsEndAtEnd: [ROUTE_VIDEOS.granvilleWb.id],
