...
export const RAILWAY = [
  ...
  {
    routeNames: [ROUTES.railway.name],
    description: "nb: crossing moncton",
    type: "painted",
    oneWay: "required",
  ...
  {
    routeNames: [ROUTES.railway.name],
    description: "nb: moncton to garry",
    type: "painted",
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.railwayNb.id, ROUTE_VIDEOS.railwayGreenwayNb.id],
    positions: [
      RAILWAY_MONCTON_NE,
      [49.12527, -123.1697],
      [49.12543, -123.16971],
  ...
  {
    routeNames: [ROUTES.railway.name],
    description: "nb: garry to steveston",
    type: "painted",
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.railwayNb.id],
    positions: [RAILWAY_GARRY_SE, NB_PRE_STEVESTON],
  },
  {
    routeNames: [ROUTES.railway.name],
  ...
  },
  {
    ...
    type: "painted",
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.railwaySb.id, ROUTE_VIDEOS.railwayGreenwaySb.id],
    positions: [
      RAILWAY_GARRY_NW,
      [49.12564, -123.16989],
      [49.12546, -123.16985],
