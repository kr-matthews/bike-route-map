...
export const KENT = [
  {
    ...
    videoIdsEndAtStart: [VIDEOS.kentWb.id],
    positions: [
      HEATHER_KENT_N,
      [49.20533, -123.12124],
      [49.20558, -123.12003],
  ...
  },
  {
    ...
    type: "quiet",
    videoIds: [VIDEOS.kentWb.id, VIDEOS.invernessSb.id],
  ...
  },
  {
    ...
    type: "quiet",
    videoIds: [VIDEOS.kentWb.id, VIDEOS.fraserRiverFraserviewEb.id],
    positions: [
      GLADSTONE_KENT,
      [49.20638, -123.06219],
      [49.20639, -123.06215],
  ...
  },
  {
    ...
    type: "mixed",
    videoIds: [VIDEOS.kentWb.id, VIDEOS.kerrSb.id],
