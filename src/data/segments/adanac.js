...
export const ADANAC = [
  ...
  {
    routeNames: [ROUTES.adanac.name],
    description: "eb: main alley and crossing",
    type: "dedicated",
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.adanacEb.id],
    positions: [EB_ALLEY_BEFORE_MAIN, MAIN_UNION_SW, MAIN_UNION_SE],
  },
  {
    routeNames: [ROUTES.adanac.name],
    description: "eb: main to dunlevy",
    type: "quiet",
    oneWay: "required",
    videoIds: [ROUTE_VIDEOS.adanacEb.id],
    positions: [
  ...
  },
  {
    ...
    type: "quiet",
    videoIds: [ROUTE_VIDEOS.adanacEb.id, ROUTE_VIDEOS.adanacWb.id],
    positions: [
      DUNLEVY_UNION,
      [49.27756, -123.09357],
      [49.27753, -123.09161],
  ...
  },
  {
    ...
    videoIds: [
      ROUTE_VIDEOS.adanacWb.id,
      ROUTE_VIDEOS.cassiarNb.id,
      ROUTE_VIDEOS.adanacEb.id,
    ],
    videoIdsStartAtStart: [ROUTE_VIDEOS.cassiarNb.id],
  ...
  },
  {
    ...
    positions: [OVERPASS_E, CASSIAR_ADANAC],
  },
  {
    routeNames: [ROUTES.adanac.name],
  ...
  },
  {
    ...
    videoIdsEndAtEnd: [ROUTE_VIDEOS.adanacEb.id],
